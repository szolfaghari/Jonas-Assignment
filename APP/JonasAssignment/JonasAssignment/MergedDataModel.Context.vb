...
Partial Public Class MergedDataEntities
    ...
    Public Overridable Function GetValueListJsonEx(year_list As String, unit_id_list As String, field_list As String) As ObjectResult(Of GetValueListJsonEx_Result)
        ...
        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of GetValueListJsonEx_Result)("GetValueListJsonEx", year_listParameter, unit_id_listParameter, field_listParameter)
    End Function

    Public Overridable Function GetFieldNames() As ObjectResult(Of GetFieldNames_Result)
        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of GetFieldNames_Result)("GetFieldNames")
    End Function
